...
namespace Engine.Graphics
{
    internal static class GLWrapper
    {
        ...
        /// <summary>
        /// �����ƫ��ͨ�����ڽ����Ȼ�������depth buffer���е�Z-fighting���⡣Z-fighting��ָ��������������������ͬ��λ���Ͻ�����Ⱦʱ�����ھ������Ƶ�����Ȼ������е�ֵ������ͻ���Ӷ����ֿɼ�������
        /// </summary>
        ...
        /// <summary>
        /// ��Ϸ������ڿ����ڻ��ƹ����У�Դ��ɫ��Ŀ����ɫ��ν��л�ϼ��㡣����Ⱦ����ʱ������ͨ��ϣ�����µ�������ɫ���̨����������ɫ���л�ϣ���ʵ��͸����Ч���������ض��Ļ��Ч����
        /// </summary>
        ...
        public static BlendEquationMode TranslateBlendFunction(BlendFunction blendFunction)
        {
            ...
            {
                case BlendFunction.Add://��Դ��ɫ��Ŀ����ɫ���
                    return BlendEquationMode.FuncAdd;
                case BlendFunction.Subtract://��Դ��ɫ�м�ȥĿ����ɫ
                    return BlendEquationMode.FuncSubtract;
                case BlendFunction.ReverseSubtract://��Ŀ����ɫ�м�ȥԴ��ɫ
        ...
        public static BlendingFactorSrc TranslateBlendSrc(Blend blend)
        {
            switch (blend)
            {
                case Blend.Zero://����������Դ��ɫ��Ŀ����ɫ
                    return BlendingFactorSrc.Zero;
                case Blend.One://��Դ��ɫ��Ŀ����ɫ����ԭ��
                    return BlendingFactorSrc.One;
                case Blend.SourceColor://ʹ��Դ��ɫ��Ϊ�������
                    return BlendingFactorSrc.SrcColor;
                case Blend.InverseSourceColor://ʹ��1��ȥԴ��ɫ��Ϊ�������
                    return BlendingFactorSrc.OneMinusSrcColor;
                case Blend.DestinationColor://ʹ��Ŀ����ɫ��Ϊ�������
                    return BlendingFactorSrc.DstColor;
                case Blend.InverseDestinationColor://ʹ��1��ȥĿ����ɫ��Ϊ�������
                    return BlendingFactorSrc.OneMinusDstColor;
                case Blend.SourceAlpha://ʹ��ԴAlphaͨ��ֵ��Ϊ�������
                    return BlendingFactorSrc.SrcAlpha;
                case Blend.InverseSourceAlpha://ʹ��1��ȥԴAlphaͨ��ֵ��Ϊ�������
                    return BlendingFactorSrc.OneMinusSrcAlpha;
                case Blend.DestinationAlpha://ʹ��Ŀ��Alphaͨ��ֵ��Ϊ�������
                    return BlendingFactorSrc.DstAlpha;
                case Blend.InverseDestinationAlpha://ʹ��1��ȥĿ��Alphaͨ��ֵ��Ϊ�������
