...
public static class ModsManager
{
	...
	public const string EVOVersion = "6";
	public const bool RevoVersion = false;
			...
			using (Stream stream = Storage.OpenFile(ks, OpenFileMode.Read))
			{
				if (ms == ".scevo")
				{
					try
					{
						...
						var modEntity = new ModEntity(ks, new SevenZipArchive(keepOpenStream, FileAccess.Read));
